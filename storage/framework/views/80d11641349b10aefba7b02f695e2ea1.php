...
>
    ...
    <?php if($post->media): ?>
        <div class="px-5 pb-4">
            <div class="rounded-xl overflow-hidden border border-gray-100 bg-black">
                ...
                <?php else: ?>
                    <img src="<?php echo e(asset('storage/' . $post->media)); ?>"
                        class="w-full h-auto block object-contain max-h-[600px]"
                        alt="Post image">
                <?php endif; ?>
   ...
   <?php echo $__env->make('components.share-modal', array_diff_key(get_defined_vars(), ['__data' => 1, '__path' => 1]))->render(); ?>
</div>
...
</script><?php /**PATH C:\Users\dikit\Desktop\projects\newsfeedfacebook\resources\views/components/post-card.blade.php ENDPATH**/ ?>