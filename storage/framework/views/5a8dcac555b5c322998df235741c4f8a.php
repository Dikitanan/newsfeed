...
<div
    x-data="commentBox(
        <?php echo e($post->id); ?>,
        <?php echo e(Js::from($post->comments->load('user'))); ?>,
        <?php echo e(Js::from([
            'id' => $post->id,
            'body' => $post->body,
            'media' => $post->media,
...
>
    ...
    <div class="p-4 flex items-center">
        ...
        <div>
            ...
            <h5 class="font-bold text-gray-800">
                <?php echo e($shared->user->name); ?>

            </h5>

            <div class="text-xs text-gray-500">
                shared a post • <?php echo e($shared->created_at->diffForHumans()); ?>
    ...
    <?php if($shared->caption): ?>
        <div class="px-5 pb-4 text-gray-700">
            <?php echo e($shared->caption); ?>
                ...
                <div class="rounded-xl overflow-hidden border border-gray-100 bg-black">
                    ...
                    <?php if(in_array($ext, ['mp4', 'mov', 'avi', 'webm'])): ?>
                        ...
                        <video
                            ...
                            preload="metadata"
                        >
                            <source src="<?php echo e(asset('storage/' . $post->media)); ?>" type="<?php echo e($mimeType); ?>">
                        </video>

                    <?php else: ?>

                        <img
                            src="<?php echo e(asset('storage/' . $post->media)); ?>"
                            class="w-full h-auto block object-contain max-h-[600px]"
                            alt="Post image"
                        >
    ...
    <div class="bg-gray-50/50 px-4 py-2 flex justify-between items-center border-t border-orange-50">
        ...
        <div class="flex space-x-2">
            ...
            <button
                onclick="toggleLike(<?php echo e($post->id); ?>, this)"
                class="flex items-center p-2 rounded-lg transition
                <?php echo e($liked ? 'text-red-500' : 'text-gray-400'); ?>"
            >
    ...
    <?php echo $__env->make('components.comment-modal', array_diff_key(get_defined_vars(), ['__data' => 1, '__path' => 1]))->render(); ?>

</div><?php /**PATH C:\Users\dikit\Desktop\projects\newsfeedfacebook\resources\views/components/shared-post-card.blade.php ENDPATH**/ ?>