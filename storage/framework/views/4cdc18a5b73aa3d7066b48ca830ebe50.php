<!-- Navbar -->
                ...
                <div class="flex items-center space-x-3">
                    <?php if(Route::has('login')): ?>
                        <?php if(auth()->guard()->check()): ?>
                            <a href="<?php echo e(url('/')); ?>" class="text-sm font-semibold text-gray-600 hover:text-green-600 px-3 py-2">My Sanctuary</a>
                        ...
                        <?php else: ?>
                            <a href="<?php echo e(route('login')); ?>" class="text-sm font-semibold text-green-700 hover:bg-green-50 px-4 py-2 rounded-full border-2 border-green-600 transition">Log in</a>

                            <?php if(Route::has('register')): ?>
                                <a href="<?php echo e(route('register')); ?>" class="text-sm font-semibold text-white bg-green-600 hover:bg-green-700 px-5 py-2 rounded-full shadow-md shadow-green-100 transition">Join the Pack</a>
                            <?php endif; ?>
                        <?php endif; ?>
                    <?php endif; ?>
                </div>
    ...
    </nav><?php /**PATH C:\Users\dikit\Desktop\projects\newsfeedfacebook\resources\views/components/navbar.blade.php ENDPATH**/ ?>